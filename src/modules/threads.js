...
export default {
  ...
  actions: {
    ...
    fetchThreads: ({dispatch}, {ids}) => dispatch('fetchItems', {resource: 'threads', emoji: 'rain', ids}, {root: true})
  },
  mutations: {
    setThread (state, {thread, threadId}) { Vue.set(state.items, threadId, thread) },
